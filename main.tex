...
\settowidth{\versewidth}{Like \textit{Rhett Butler} without \textit{Scarlett},}
\begin{verse}[\versewidth]
    Like the web without \textit{Charlotte},\poeticmarginnote{Ps 46.8-11}\\*
    Like \textit{Rhett Butler} without \textit{Scarlett},\poeticmarginnote{Hovis Presley}\\
...
\chapter*{An Elegy for Kirstie Foster}
